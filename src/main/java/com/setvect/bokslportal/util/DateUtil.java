...
public abstract class DateUtil {
  ...
  /**
   * @param t       타임 스템프 형식의 시간
   * @param pattern 표현할 패턴
   * @return 변환된 패턴 스트링
   */
   ...
   * 두날짜 차이 구하기
   *
   * @param startDate 날짜 시작
   * @param format    날짜 종료
   * @return 두 날짜의 차이 (타임스템프)
   * @throws Exception 파싱 예외
   */
   ...
   * @param endDate   종료 날짜
   * @param format    날짜 형식 기본값: yyyy-MM-dd HH:mm:ss.SSS
   ...
   * @param endDate   종료 날짜
   * @param format    날짜 포맷 (ex: yyyy-MM-dd HH:mm:ss.SSS)
   * @return 두 날짜에 차이 일수
   */
   ...
   *
   * @param dateString 문자형 날짜
   * @param dateFormat 데이터 포맷
   * @return Date
   */
   ...
   *
   * @param dateString 날짜로된 만자열
   * @param paramF     전달될는 문자열 포맷
   * @param retF       리턴될 포맷
   * @return 리턴될 포맷
   */
   ...
   *
   * @param cal       날짜
   * @param fristWeek 주(week)에 시작 요일. Calendar 클래스 상수값 이용
