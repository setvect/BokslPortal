...
public class FileUtil extends FileUtils {
   ...
   *
   * @param baseDir      파일 탐색 시작 지점
   * @param subDirectory 하위 디렉토리 탐색 여부
   * @param exts         확장자 <br>
   * @return 결과 파일 목록
   */
  ...
  private static class FileFinder {
    ...
    /**
     * @param baseDir 검색 시작 디렉토리
     * @param ext     검색 대상 확장자. 확장자는 포함 <br>
     *                ex) hwp, mp3, ...
     */
   ...
   * @param downloadFileName Download file name from client computer
